...
extern void ultrasonic_processing_w(void);
extern void set_time_button_w(void);
extern void lcd_display_mode_select_w(void);
 ...
 // servo_motor_test_main();  // test ?���???? 막기.
  ...
  while (1)
  {
	...
	//  DHT11_processing();
	  ...
	  ultrasonic_processing_w(); // 거리
	  lcd_display_mode_select_w();
